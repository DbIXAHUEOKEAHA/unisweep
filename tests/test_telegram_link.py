...
def test_the_service_address_is_compiled_in():
    ...
    # here once and went unnoticed for a week: every machine that had
    # ever been paired carried the real address in its gitignored
    # config/settings.json, which overrides the constant, so only a
    # *fresh* install ever dialled it — and got "Application not found".
